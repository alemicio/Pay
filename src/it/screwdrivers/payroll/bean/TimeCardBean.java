...
public class TimeCardBean implements Serializable {
	...
	public void submitTimeCard(){
		...
		hours_worked = ( end_time.getHours()+(float)((float)end_time.getMinutes()/60)) - (start_time.getHours() + (float)((float)start_time.getMinutes()/60) );
		...
		response =t_controller.registerTimeCard(t_card);
